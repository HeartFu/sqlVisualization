...
function() {
      ...
      return function(f, g, h, i) {
          if ("contextmenu" == g && r) k(f, g, h, i);
              ...
              if (null == f.__taTapHandler) {
                  ...
                  l = function(d) {
                      for (var e = d.srcElement || d.target,
                      g = 0; g < j.downSelectors.length; g++) if (null == j.downSelectors[g] || b(e, j.downSelectors[g], f)) {
                          j.down = !0,
                          setTimeout(o, a),
                          setTimeout(p, c);
                          break
              ...
              f.__taTapHandler.downSelectors.push(i),
              f.__taTapHandler[g].push([h, i]),
  ...
  p = function() {
      ...
      return function(c, e, f, h) {
          if (!c.__tamee) {
              ...
              var j = function(e) {
                  var f = d(e); (null == h && f == c && !c.__tamee.over || b(f, h, c) && (null == f.__tamee || !f.__tamee.over)) && (o("mouseenter", e, c, f), f.__tamee = f.__tamee || {},
                  f.__tamee.over = !0, a.push(f))
              },
              k = function(e) {
                  for (var f = d(e), g = 0; g < a.length; g++) f != a[g] || b(e.relatedTarget || e.toElement, "*", f) || (f.__tamee.over = !1, a.splice(g, 1), o("mouseexit", e, c, f))
              };
              C(c, "mouseover", i(h, c, j, "mouseover"), j),
              C(c, "mouseout", i(h, c, k, "mouseout"), k)
          }
          f.__taUnstore = function() {
              delete c.__tamee[e][f.__tauid]
          },
          g(c, e, f),
          c.__tamee[e][f.__tauid] = f
      }
  },
  ...
  D = function(a, b, d) {
      ...
      function() {
          var e = c(this);
          if (h(e, b, d), null != d.__tauid) if (e.removeEventListener) e.removeEventListener(b, d, !1),
          q && s[b] && e.removeEventListener(s[b], d, !1);
  ...
  Mottle.setForceTouchEvents = function(a) {
      q = a
  },
...
function() {
  ...
  k = j.jsPlumbUtil = {
      ...
      indexOf: function(a, b) {
          return a.indexOf ? a.indexOf(b) : k.findWithFunction(a,
          function(a) {
              return a == b
          })
      },
  ...
  k.EventGenerator = function() {
      ...
      this.bind = function(b, c, d) {
          var e = function(b) {
              ...
              c.__jsPlumb[jsPlumbUtil.uuid()] = b
          };
      ...
      this.unbind = function(b, c) {
          if (0 === arguments.length) a = {};
              ...
              if ("string" == typeof b) delete a[b];
                  ...
                  var d;
                  for (var e in b.__jsPlumb) d = b.__jsPlumb[e],
                  k.remove(a[d] || [], b)
              }
...
function() {
  ...
  f = function(a) {
      if (a._jsPlumb.paintStyle && a._jsPlumb.hoverPaintStyle) {
          var b = {};
          q.extend(b, a._jsPlumb.paintStyle),
          q.extend(b, a._jsPlumb.hoverPaintStyle),
  ...
  k = function(a, b, c) {
      if (a.getDefaultType) {
          ...
          j(f, g, "__default");
          for (var i = 0,
          k = a._jsPlumb.types.length; k > i; i++) {
  ...
  jsPlumbUtil.extend(l, jsPlumbUtil.EventGenerator, {
      ...
      removeType: function(a, b) {
          ...
          if (null != c) {
              for (var g = 0,
              h = c.length; h > g; g++) e = f(c[g]) || e;
              e && k(this, null, b)
          }
      },
      clearTypes: function(a) {
          for (var b = this._jsPlumb.types.length,
          c = 0; b > c; c++) m(this, 0),
  ...
  p = window.jsPlumbInstance = function(b) {
      ...
      this.setZoom = function(a, b) {
          return jsPlumbUtil.oldIE || (k = a, f.fire("zoom", k), b && f.repaintEverything()),
          !jsPlumbUtil.oldIE
      },
      ...
      this.setContainer = function(a) {
          ...
          d = function(a) {
              c(a, "._jsPlumb_connector > *",
              function(c) {
                  b(a, c)
              }),
              c(a, "._jsPlumb_endpoint, ._jsPlumb_endpoint > *, ._jsPlumb_endpoint svg *",
              function(c) {
                  b(a, c)
              }),
              c(a, "._jsPlumb_overlay, ._jsPlumb_overlay *",
              function(c) {
                  b(a, c)
              })
          },
      ...
      M = function(a, b, c, e) {
          if (!q.headless) {
              ...
              if (g && q.isDragSupported(a, f) && !q.isAlreadyDraggable(a, f)) {
                  ...
                  h[k] = d.wrap(h[k],
                  function() {
                      return o = null != m ? f.getOffset(m) : n,
                      f.setHoverSuspended(!0),
                      f.select({
                          source: a
                      }).addClass(f.elementDraggingClass + " " + f.sourceElementDraggingClass, !0),
                      f.select({
                          target: a
                      }).addClass(f.elementDraggingClass + " " + f.targetElementDraggingClass, !0),
                      f.setConnectionBeingDragged(!0),
                      h.canDrag ? c.canDrag() : void 0
                  },
                  !1),
                  h[i] = d.wrap(h[i],
                  function() {
                      ...
                      b.top += o.top,
                      K(a, b, null, !0),
                      p && f.addClass(a, "jsPlumb_dragged"),
                      p = !0
                  }),
                  h[j] = d.wrap(h[j],
                  function() {
                      ...
                      for (var c = function(a) {
                          K(a[0], a[1]),
                          f.removeClass(a[0], "jsPlumb_dragged"),
                          f.select({
                              source: a[0]
                          }).removeClass(f.elementDraggingClass + " " + f.sourceElementDraggingClass, !0),
                          f.select({
                              target: a[0]
                          }).removeClass(f.elementDraggingClass + " " + f.targetElementDraggingClass, !0),
                          f.getDragManager().dragEnded(a[0])
                      },
      ...
      O = function(a, b) {
          var c = q.extend({},
          a);
          if (b && q.extend(c, b), c.source && (c.source.endpoint ? c.sourceEndpoint = c.source: c.source = f.getElement(c.source)), c.target && (c.target.endpoint ? c.targetEndpoint = c.target: c.target = f.getElement(c.target)), a.uuids && (c.sourceEndpoint = L(a.uuids[0]), c.targetEndpoint = L(a.uuids[1])), c.sourceEndpoint && c.sourceEndpoint.isFull()) return d.log(f, "could not add connection; source endpoint is full"),
          void 0;
          if (c.targetEndpoint && c.targetEndpoint.isFull()) return d.log(f, "could not add connection; target endpoint is full"),
          void 0;
          if (!c.type && c.sourceEndpoint && (c.type = c.sourceEndpoint.connectionType), c.sourceEndpoint && c.sourceEndpoint.connectorOverlays) {
              ...
              for (var e = 0,
              g = c.sourceEndpoint.connectorOverlays.length; g > e; e++) c.overlays.push(c.sourceEndpoint.connectorOverlays[e])
          ...
          j = function(a, b, d) {
              if (c[a] && !c[a].endpoint && !c[a + "Endpoint"] && !c.newConnection) {
                  ...
                  if (f) {
                      ...
                      c[a + "Endpoint"] = g,
                      g._doNotDeleteOnDetach = !1,
                      g._deleteOnDetach = !0,
                      f.uniqueEndpoint && (f.endpoint ? g.finalEndpoint = f.endpoint: (f.endpoint = g, g._deleteOnDetach = !1, g._doNotDeleteOnDetach = !0))
                  }
              }
          };
      ...
      P = function(a) {
          ...
          a.id = "con_" + I();
          var c = new b(a);
          return c.isDetachable() && (c.endpoints[0].initDraggable(), c.endpoints[1].initDraggable()),
          c
      },
      Q = f.finaliseConnection = function(a, b, c, d) {
          if (b = b || {},
          a.suspendedEndpoint || u.push(a), a.endpoints[0].isTemporarySource = !1, (null == a.suspendedEndpoint || d) && f.anchorManager.newConnection(a), K(a.source), !b.doNotFireConnectionEvent && b.fireEvent !== !1) {
              var e = {
                  connection: a,
                  source: a.source,
                  target: a.target,
      ...
      R = function(a, b) {
          ...
          var e = new c(d);
          return e.id = "ep_" + I(),
          pb(d.elementId, d.source),
          q.headless || f.getDragManager().endpointAdded(d.source, b),
          e
      },
      S = function(a, b, c) {
          var d = v[a];
      ...
      Y = function(a, b, c) {
          ...
          return d && "undefined" !== d || (2 == arguments.length && void 0 !== arguments[1] ? d = b: (1 == arguments.length || 3 == arguments.length && !arguments[2]) && (d = "jsPlumb_" + h + "_" + I()), c || f.setAttribute(a, "id", d)),
          d
      };
      ...
      this.checkCondition = function(a) {
          ...
          if (b && b.length > 0) {
              ...
              try {
                  for (var g = 0,
                  h = b.length; h > g; g++) c = c && b[g].apply(b[g], e)
              } catch(i) {
      ...
      this.connect = function(a, b) {
          var c, d = O(a, b);
          if (d) {
              if (null == d.source && null == d.sourceEndpoint) return jsPlumbUtil.log("Cannot establish connection - source does not exist"),
              void 0;
              if (null == d.target && null == d.targetEndpoint) return jsPlumbUtil.log("Cannot establish connection - target does not exist"),
              void 0;
              nb(d.source),
              c = P(d),
              Q(c, d)
      ...
      $ = function(a, b, c, d) {
          ...
          if (b.constructor == q.Endpoint) e = b,
          e.addConnection(a);
          ...
          if (0 !== arguments.length) {
              ...
              if (g)(e || jsPlumbUtil.functionChain(!0, !1, [[g.endpoints[0], "isDetachAllowed", [g]], [g.endpoints[1], "isDetachAllowed", [g]], [g, "isDetachAllowed", [g]], [f, "checkCondition", ["beforeDetach", g]]])) && g.endpoints[0].detach(g, !1, !0, d);
                  ...
                  if (h.uuids) L(h.uuids[0]).detachFrom(L(h.uuids[1]), d);
                      ...
                      S(i,
                      function(a) { (a.sourceId == i && a.targetId == j || a.targetId == i && a.sourceId == j) && f.checkCondition("beforeDetach", a) && a.endpoints[0].detach(a, !1, !0, d)
                      })
                  }
              }
          }
      ...
      this.detachAllConnections = function(a, b) {
          ...
          d = v[c];
          if (d && d.length) for (var e = 0,
          g = d.length; g > e; e++) d[e].detachAll(b.fireEvent !== !1, b.forceDetach);
          return f
      },
      this.detachEveryConnection = function(a) {
          ...
          f.batch(function() {
              for (var b in v) {
                  var c = v[b];
                  if (c && c.length) for (var d = 0,
                  e = c.length; e > d; d++) c[d].detachAll(a.fireEvent !== !1, a.forceDetach)
              }
              u.length = 0
          }),
          f
      ...
      this.deleteObject = function(a) {
          ...
          for (var h in b.connections) {
              ...
              i._jsPlumb && (jsPlumbUtil.removeWithFunction(u,
              function(a) {
                  return i.id == a.id
      ...
      this.draggable = function(a, b) {
          var c, d, e;
          if ("object" == typeof a && a.length) for (c = 0, d = a.length; d > c; c++) e = m(a[c]),
          e.el && M(e.el, !0, b, e.id);
          else e = m(a),
          e.el && M(e.el, !0, b, e.id);
          return f
      };
      ...
      fb = function(a, b) {
          ...
          e = a.length; e > d; d++) c.push(m(a[d]).id);
          else c.push(m(a).id);
          return c
      },
      gb = function(a, b, c) {
      ...
      lb = function(a) {
          ...
          return q.extend(b, {
              ...
              remove: function() {
                  for (var b = 0,
                  c = a.length; c > b; b++) f.deleteObject({
                      endpoint: a[b]
                  })
              }
          })
      ...
      this.select = function(a) {
          return a = a || {},
          a.scope = a.scope || "*",
          kb(a.connections || f.getConnections(a, !0))
      },
      ...
      this.init = function() {
          ...
          var b = function(a, b, c) {
              q.Connectors[a][b] = function() {
                  ...
                  q.ConnectorRenderers[a].apply(this, arguments)
              },
      ...
      tb = function(a, b, c, e, g, h) {
          ...
          k = q.dragEvents.drop;
          return c.scope = c.scope || b.scope || f.Defaults.Scope,
          c[k] = d.wrap(c[k], j, !0),
          g && (c[q.dragEvents.over] = function() {
              return ! 0
          }),
          ...
          f.initDroppable(a.el, c, "internal"),
          j
      };
      this.makeTarget = function(a, b, c) {
          ...
          for (var e = (!(d.deleteEndpointsOnDetach === !1), d.maxConnections || -1), f = function(a) {
              ...
              b.el._jsPlumbTarget = g,
              this.targetEndpointDefinitions[c] = g,
              tb(b, d, f, d.isSource === !0, !0, "_jsPlumbTarget")
          }.bind(this), g = a.length && a.constructor != String ? a: [a], h = 0, i = g.length; i > h; h++) f(g[h]);
          return this
      },
      this.unmakeTarget = function(a, b) {
          var c = m(a);
          return q.destroyDroppable(c.el),
      ...
      this.makeSource = function(a, b, c) {
          ...
          i = function(a) {
              ...
              this.sourceEndpointDefinitions[b] = i,
              a.el._jsPlumbSource = i;
              ...
              var s = function(d) {
                  ...
                  if (3 !== d.which && 2 !== d.button) {
                      ...
                      if (j.enabled) {
                          ...
                          s = {};
                          q.extend(s, e),
                          s.isTemporarySource = !0,
                          s.anchor = [o[0], o[1], 0, 0],
                          s.dragOptions = m,
                          p = this.addEndpoint(b, s),
                          r = !0,
                          p._doNotDeleteOnDetach = !1,
                          p._deleteOnDetach = !0,
                          j.uniqueEndpoint && (j.endpoint ? p.finalEndpoint = j.endpoint: (j.endpoint = p, p._deleteOnDetach = !1, p._doNotDeleteOnDetach = !0));
                          var t = function() {
                              f.off(p.canvas, "mouseup", t),
                              f.off(a.el, "mouseup", t),
                              r && (r = !1, f.deleteEndpoint(p))
                          };
                          f.on(p.canvas, "mouseup", t),
                          f.on(a.el, "mouseup", t),
                          f.trigger(p.canvas, "mousedown", d),
                          jsPlumbUtil.consume(d)
                      }
                  }
              }.bind(this);
              this.on(a.el, "mousedown", s),
              i.trigger = s,
              e.filter && (jsPlumbUtil.isString(e.filter) || jsPlumbUtil.isFunction(e.filter)) && f.setDragFilter(a.el, e.filter);
              var t = q.extend({},
              e.dropOptions || {});
      ...
      this.unmakeSource = function(a, b) {
          ...
          return d && f.off(c.el, "mousedown", d),
      ...
      var zb = function(a, b) {
          ...
          for (var c = function(a) {
              f.getDragManager().elementRemoved(a.id),
      ...
      this.setId = function(a, b, c) {
          ...
          !0);
          b = "" + b,
          c ? a = this.getElement(b) : (a = this.getElement(d), this.setAttribute(a, "id", b)),
          v[b] = v[d] || [];
          for (var g = 0,
          h = v[b].length; h > g; g++) v[b][g].setElementId(b),
          v[b][g].setReferenceElement(a);
          delete v[d],
          this.anchorManager.changeId(d, b),
          this.getDragManager().changeId(d, b),
          x[b] = x[d],
          delete x[d];
  ...
  jsPlumbUtil.extend(p, jsPlumbUtil.EventGenerator, {
      ...
      convertToFullOverlaySpec: function(a) {
          ...
          a[1].id = a[1].id || jsPlumbUtil.uuid(),
          a
      },
      registerConnectionType: function(a, b) {
          if (this._connectionTypes[a] = q.extend({},
          b), b.overlays) {
              for (var c = {},
              d = 0; d < b.overlays.length; d++) {
      ...
      registerEndpointType: function(a, b) {
          this._endpointTypes[a] = q.extend({},
          b)
      },
      registerEndpointTypes: function(a) {
          for (var b in a) this._endpointTypes[b] = q.extend({},
          a[b])
      },
  ...
  var q = new p;
  "undefined" != typeof window && (window.jsPlumb = q),
  q.getInstance = function(a) {
      var b = new p(a);
      return b.init(),
      b
  },
  q.each = function(a, b) {
      if (null != a) if ("string" == typeof a) b(q.getElement(a));
      else if (null != a.length) for (var c = 0; c < a.length; c++) b(q.getElement(a[c]));
      else b(a)
  },
...
function() {
  ...
  p = function(a, b, c) {
      b = null == b ? [] : jsPlumbUtil.isArray(b) ? b: b.split(/\s+/),
      c = null == c ? [] : jsPlumbUtil.isArray(c) ? c: c.split(/\s+/);
      var d = o(a),
      e = d.split(/\s+/),
      f = function(a, b) {
  ...
  jsPlumb.extend(jsPlumbInstance.prototype, {
      ...
      getDragManager: function() {
          return null == this.dragManager && (this.dragManager = new l(this)),
          this.dragManager
      },
      ...
      hasClass: function(a, b) {
          ...
          a.classList ? a.classList.contains(b) : -1 != o(a).indexOf(b)
      },
...
function() {
  ...
  b.OverlayCapableJsPlumbUIComponent = function(a) {
      ...
      a.label && (this.getDefaultType().overlays[d] = ["Label", {
          label: a.label,
      ...
      if (b.overlays) {
          ...
          for (c in b.overlays) {
              ...
              d[b.overlays[c][1].id] = !0;
                  ...
                  null != f ? (f.reattach(a._jsPlumb.instance), f.updateFrom(b.overlays[c][1]), a._jsPlumb.overlays[f.id] = f) : f = a.addOverlay(b.overlays[c], !0),
                  d[f.id] = !0
              }
          }
...
function() {
  ...
  i = function(a, b) {
      return c.findWithFunction(b.connections,
      function(b) {
          return b.id == a.id
      })
  };
  b.Endpoint = function(a) {
      ...
      var n = function() {
          ...
          this.removeClass(a),
          this.addClass(b),
          jsPlumb.updateClasses(this.element, b, a)
      }.bind(this);
      ...
      this.scope = a.scope || j.getDefaultScope(),
      this.timestamp = null,
      this.reattachConnections = a.reattach || j.Defaults.ReattachConnections,
      this.connectionsDetachable = j.Defaults.ConnectionsDetachable,
      ...
      this.addConnection = function(a) {
          ...
          this[(this.connections.length > 0 ? "add": "remove") + "Class"](j.endpointConnectedClass),
          this[(this.isFull() ? "add": "remove") + "Class"](j.endpointFullClass)
      },
      this.detachFromConnection = function(a, b, c) {
          b = null == b ? i(a, this) : b,
          b >= 0 && (this.connections.splice(b, 1), this[(this.connections.length > 0 ? "add": "remove") + "Class"](j.endpointConnectedClass), this[(this.isFull() ? "add": "remove") + "Class"](j.endpointFullClass)),
          !c && this._deleteOnDetach && 0 === this.connections.length && j.deleteObject({
              endpoint: this,
              fireEvent: !1,
      ...
      this.detach = function(a, b, c, d, e, f, g) {
          ...
          k = !1;
          return d = d !== !1,
          h >= 0 && (c || a._forceDetach || a.isDetachable() && a.isDetachAllowed(a) && this.isDetachAllowed(a) && j.checkCondition("beforeDetach", a, f)) && (j.deleteObject({
              connection: a,
              fireEvent: !b && d,
              originalEvent: e,
              deleteAttachedObjects: !1
      ...
      this.setElement = function(b) {
          ...
          this.element = jsPlumb.getElement(b),
          this.elementId = j.getId(this.element),
          j.anchorManager.rehomeEndpoint(this, e, this.element),
          j.dragManager.endpointAdded(this.element),
          c.addToList(a.endpointsByElement, d, this),
          this
      },
      ...
      this.initDraggable = function() {
          if (!p && b.isDragSupported(this.element)) {
              ...
              v = function() {
                  ...
                  var b = !0;
                  this.isEnabled() || (b = !1),
                  null != h || this.isSource || this.isTemporarySource || (b = !1),
                  !this.isSource || !this.isFull() || null != h && this.dragAllowedWhenFull || (b = !1),
                  null == h || h.isDetachable(this) || (b = !1);
                  ...
                  if (d === !1 && (b = !1), b === !1) return j.stopDrag && j.stopDrag(this.canvas),
                  o.stopDrag(),
                  !1;
                  for (var p = 0; p < this.connections.length; p++) this.connections[p].setHover(!1);
                  this.addClass("endpointDrag"),
                  j.setConnectionBeingDragged(!0),
                  h && !this.isFull() && this.isSource && (h = null),
                  j.updateOffset({
                      elId: this.elementId
                  }),
                  m = this.makeInPlaceCopy(),
                  m.addClass(j.draggingClass),
                  m.referenceEndpoint = this,
                  m.paint(),
                  e(g, j);
                  ...
                  if (jsPlumb.setPosition(g.element, q), this.parentAnchor && (this.anchor = j.makeAnchor(this.parentAnchor, this.elementId, j)), j.setAttributes(this.canvas, {
                      dragId: g.id,
                      elId: this.elementId
                  }), this._jsPlumb.floatingEndpoint = f(this.getPaintStyle(), this.anchor, this.endpoint, this.canvas, g.element, j, l, this.scope), this.canvas.style.visibility = "hidden", null == h) this.anchor.locked = !0,
                  this.setHover(!1, !1),
                  h = k({
                      sourceEndpoint: this,
                  ...
                  h.addClass(j.draggingClass),
                  this._jsPlumb.floatingEndpoint.addClass(j.draggingClass),
                  j.fire("connectionDrag", h);
                  else {
                      i = !0,
                      h.setHover(!1);
                      ...
                      j.setDragScope(r, u),
                      j.fire("connectionDrag", h),
                      0 === s ? (n = [h.source, h.sourceId, r, t], h.source = g.element, h.sourceId = g.id) : (n = [h.target, h.targetId, r, t], h.target = g.element, h.targetId = g.id),
                      h.endpoints[0 === s ? 1 : 0].anchor.locked = !0,
                      h.suspendedEndpoint = h.endpoints[s],
                      h.suspendedElement = h.endpoints[s].getElement(),
                      h.suspendedElementId = h.endpoints[s].elementId,
                      h.suspendedElementType = 0 === s ? "source": "target",
                      h.suspendedEndpoint.setHover(!1),
                      this._jsPlumb.floatingEndpoint.referenceEndpoint = h.suspendedEndpoint,
                      h.endpoints[s] = this._jsPlumb.floatingEndpoint,
                      h.addClass(j.draggingClass),
                      this._jsPlumb.floatingEndpoint.addClass(j.draggingClass)
                  }
                  j.floatingConnections[g.id] = h,
                  j.anchorManager.addFloatingConnection(g.id, h),
                  c.addToList(a.endpointsByElement, g.id, this._jsPlumb.floatingEndpoint),
                  j.currentlyDragging = !0
              }.bind(this),
              w = function() {
                  if (j.setConnectionBeingDragged(!1), h && null != h.endpoints) {
                      ...
                      if (h.endpoints[0 === b ? 1 : 0].anchor.locked = !1, h.removeClass(j.draggingClass), this._jsPlumb && (h.deleteConnectionNow || h.endpoints[b] == this._jsPlumb.floatingEndpoint) && i && h.suspendedEndpoint) {
                          ...
                          j.setDragScope(n[2], n[3]),
                          h.endpoints[b] = h.suspendedEndpoint,
                          h.isReattach() || h._forceReattach || h._forceDetach || !h.endpoints[0 === b ? 1 : 0].detach(h, !1, !1, !0, a, !0) ? (h.setHover(!1), h._forceDetach = null, h._forceReattach = null, this._jsPlumb.floatingEndpoint.detachFromConnection(h), h.suspendedEndpoint.addConnection(h), j.repaint(n[1])) : j.deleteObject({
                              endpoint: c
                          })
                      }
                      j.remove(g.element, !1),
                      j.deleteObject({
                          endpoint: m
                      }),
                      ...
                      j.fire("connectionDragStop", h, a),
                      j.currentlyDragging = !1,
                      h = null
                  }
              }.bind(this);
              q = b.extend(r, q),
              q.scope = this.scope || q.scope,
              q[s] = c.wrap(q[s], v, !1),
              q[u] = c.wrap(q[u], o.drag),
              q[t] = c.wrap(q[t], w),
              q.multipleDrop = !1,
              q.canDrag = function() {
                  return this.isSource || this.isTemporarySource || this.connections.length > 0
              }.bind(this),
              j.initDraggable(this.canvas, q, "internal"),
      ...
      var t = function(d, e, f, g, h) {
          if ((this.isTarget || e) && b.isDropSupported(this.element)) {
              ...
              i = b.extend({},
              i),
              i.scope = i.scope || this.scope;
              var k = b.dragEvents.drop,
              l = b.dragEvents.over,
              m = b.dragEvents.out,
              n = this,
              o = j.EndpointDropHandler({
              ...
              function() {
                  ...
                  if (null != d) {
                      ...
                      if (f) {
                          ...
                          this[(g ? "add": "remove") + "Class"](j.endpointDropAllowedClass),
                          this[(g ? "remove": "add") + "Class"](j.endpointDropForbiddenClass),
              ...
              j.initDroppable(d, i, "internal", f)
          }
      }.bind(this);
      return this.anchor.isFloating || t(this.canvas, !0, !(a._transient || this.anchor.isFloating), this, a.reference),
      this
  },
  c.extend(b.Endpoint, b.OverlayCapableJsPlumbUIComponent, {
      ...
      cleanup: function() {
          ...
          jsPlumb.removeClass(this.element, a),
          this.anchor = null,
  ...
  a.jsPlumbInstance.prototype.EndpointDropHandler = function(a) {
      return function(b) {
          ...
          if (null != h && (!h.suspendedEndpoint || null != h.suspendedEndpoint._jsPlumb)) {
              ...
              if (a.isRedrop(h, a)) return h._forceReattach = !0,
              h.setHover(!1),
              a.maybeCleanup && a.maybeCleanup(i),
              void 0;
              ...
              if ((0 !== j || a.isSource) && (1 !== j || a.isTarget)) {
                  ...
                  d), !a.isFull() && (0 !== j || a.isSource) && (1 != j || a.isTarget) && a.enabled()) {
                      var k = !0;
                      0 === j ? (h.source = a.element, h.sourceId = a.elementId) : (h.target = a.element, h.targetId = a.elementId),
                      h.suspendedEndpoint && h.suspendedEndpoint._jsPlumb && h.suspendedEndpoint.id != i.id && (h.isDetachAllowed(h) && h.endpoints[j].isDetachAllowed(h) && h.suspendedEndpoint.isDetachAllowed(h) && c.checkCondition("beforeDetach", h) || (k = !1));
                      var l = function(a) {
                          h.endpoints[j].detachFromConnection(h),
                          ...
                          if (1 == j ? c.anchorManager.updateOtherEndpoint(h.sourceId, h.suspendedElementId, h.targetId, h) : c.anchorManager.sourceChanged(h.suspendedEndpoint.elementId, h.sourceId, h), h.endpoints[0].finalEndpoint) {
                              var g = h.endpoints[0];
                              g.detachFromConnection(h),
                              h.endpoints[0] = h.endpoints[0].finalEndpoint,
                              h.endpoints[0].addConnection(h)
                          }
                          jsPlumbUtil.isObject(a) && h.mergeData(a),
                          c.finaliseConnection(h, null, d),
                          h.setHover(!1)
                      }.bind(this),
                      m = function() {
                      ...
                      if (k = k && a.isDropAllowed(h.sourceId, h.targetId, h.scope, h, i)) return l(k),
                      !0;
                      m()
                  }
                  a.maybeCleanup && a.maybeCleanup(i),
...
function() {
  ...
  c.extend(b.Connection, b.OverlayCapableJsPlumbUIComponent, {
      applyType: function(a, c, d) {
          ...
          null != e && (this.endpoints[0].anchor = e[0], this.endpoints[1].anchor = e[1]),
          b.OverlayCapableJsPlumbUIComponent.applyType(this, a)
      },
      addClass: function(a, b) {
      ...
      prepareEndpoint: function(a, c, d, f, g, h, i, j) {
          ...
          f.addConnection(d);
              ...
              null == m.fillStyle && null != h.paintStyle && (m.fillStyle = h.paintStyle.strokeStyle),
              null == m.outlineColor && null != h.paintStyle && (m.outlineColor = h.paintStyle.outlineColor),
  ...
  c.AnchorManager = function(a) {
      ...
      this.newConnection = function(a) {
          ...
          h = function(h, i, k, l, m) {
              d == e && k.isContinuous && (a._jsPlumb.instance.removeElement(f[1].canvas), g = !1),
      ...
      this.connectionDetached = function(a) {
          ...
          h = function(a, d, e, f, g) {
              null != e && e.constructor == c.FloatingAnchor || b.removeWithFunction(j[f],
              function(a) {
                  return a[0].id == g.id
              })
          };
      ...
      this.updateOtherEndpoint = function(a, d, e, f) {
          var g = b.findWithFunction(j[a],
          function(a) {
              return a[0].id === f.id
          }),
          h = b.findWithFunction(j[d],
          function(a) {
              return a[0].id === f.id
          }); - 1 != g && (j[a][g][0] = f, j[a][g][1] = f.endpoints[1], j[a][g][2] = f.endpoints[1].anchor.constructor == c.DynamicAnchor),
          h > -1 && (j[d].splice(h, 1), b.addToList(j, e, [f, f.endpoints[0], f.endpoints[0].anchor.constructor == c.DynamicAnchor])),
          f.updateConnectedClass()
      },
      this.sourceChanged = function(a, d, e) {
          if (a !== d) {
              b.removeWithFunction(j[a],
              function(a) {
                  return a[0].id === e.id
              });
              var f = b.findWithFunction(j[e.targetId],
              function(a) {
                  return a[0].id === e.id
              });
              f > -1 && (j[e.targetId][f][0] = e, j[e.targetId][f][1] = e.endpoints[0], j[e.targetId][f][2] = e.endpoints[0].anchor.constructor == c.DynamicAnchor),
          ...
          if (!m.isSuspendDrawing()) {
              ...
              x = 0; x < p.length; x++) {
                  ...
                  if (B || C) {
                      ...
                      H = m.getCachedData(z);
                      A == z && (B || C) ? w(l[z], -Math.PI / 2, 0, y, !1, A, 0, !1, "top", z, q, r) : (E || (E = o(z, A, H.o, G.o, y.endpoints[0].anchor, y.endpoints[1].anchor), v[D] = E), B && w(l[z], E.theta, 0, y, !1, A, 0, !1, E.a[0], z, q, r), C && w(l[A], E.theta2, -1, y, !0, z, 1, !0, E.a[1], A, q, r)),
                      B && b.addWithFunction(s, z,
                      function(a) {
                          return a === z
                      }),
                      C && b.addWithFunction(s, A,
                      function(a) {
                          return a === A
                      }),
                      b.addWithFunction(q, y,
                      function(a) {
                          return a.id == y.id
                      }),
                      (B && 0 === F || C && 1 === F) && b.addWithFunction(r, y.endpoints[F],
                      function(a) {
              ...
              !1, a, 0, !1, k[x].anchor.getDefaultFace(), a, q, r), b.addWithFunction(s, a,
              function(b) {
                  return b === a
              }));
              ...
              for (x = 0; x < p.length; x++) {
                  ...
                  if (J.anchor.constructor == c.DynamicAnchor) {
                      ...
                      b.addWithFunction(q, p[x][0],
                      function(a) {
                          return a.id == p[x][0].id
                      });
                      for (var K = 0; K < J.connections.length; K++) J.connections[K] !== p[x][0] && b.addWithFunction(q, J.connections[K],
                      function(a) {
                          return a.id == J.connections[K].id
                      })
                  } else J.anchor.constructor == c.Anchor && b.addWithFunction(q, p[x][0],
                  function(a) {
                      return a.id == p[x][0].id
                  })
              }
      ...
      var x = function(a) {
          ...
          this.isDynamic = !0,
          this.isContinuous = !0;
          for (var c = a.faces || ["top", "right", "bottom", "left"], d = !(a.clockwise === !1), h = {},
          i = {
              top: "bottom",
              right: "left",
              left: "right",
...
function() {
  ...
  b.Segments = {
      ...
      Arc: function(a) {
          ...
          this.segment = d.quadrant([this.x1, this.y1], [this.x2, this.y2]);
          ...
          this.gradientAtPoint = function(b, c) {
              ...
              return this.anticlockwise || 1 / 0 != f && f != -1 / 0 || (f *= -1),
              f
          },
  ...
  c.extend(b.Connectors.Straight, b.Connectors.AbstractConnector),
  b.registerConnectorType(f, "Straight"),
  ...
  b.Endpoints.Image = function(d) {
      ...
      this._jsPlumb.endpoint.setImage(f, e),
      ...
      this.draw = function(a, g) {
          ...
          if (a.pointAlongPathFrom) {
              if (c.isString(this.loc) || this.loc > 1 || this.loc < 0) {
                  ...
                  i = a.pointAlongPathFrom(n, m - b * this.length / 2, !1),
                  j = d.pointOnLine(h, i, this.length)
              } else if (1 == this.loc) {
              ...
              } else h = a.pointAlongPathFrom(this.loc, b * this.length / 2),
              i = a.pointOnPath(this.loc),
              j = d.pointOnLine(h, i, this.length);
              k = d.perpendicularLineTo(h, j, this.width),
              l = d.pointOnLine(h, j, f * this.length);
              var q = {
                  hxy: h,
                  tail: k,
                  cxy: l
      ...
      this.draw = function(a, b, d) {
          ...
          if (null != e && 2 == e.length) {
              ...
              if (d) f = {
                  ...
                  var g = this.loc,
                  h = !1; (c.isString(this.loc) || this.loc < 0 || this.loc > 1) && (g = parseInt(this.loc, 10), h = !0),
                  f = a.pointOnPath(g, h)
              } else {
  ...
  c.extend(b.Overlays.Label, b.Overlays.Custom, {
      ...
      getDimensions: function() {
          return this.update(),
          j.prototype.getDimensions.apply(this, arguments)
      },
      update: function() {
...
function() {
  ...
  d = function(a) {
      ...
      this._compute = function(a, b) {
          if (b.clearEdits && (h = null), null != h) return p(this, h, a),
          void 0;
          c = [],
          i = null,
          j = null,
...
function() {
  ...
  c.extend(f, b.Connectors.AbstractConnector),
...
function() {
  ...
  t = function(a, b) {
      ...
      b.version = "1.1",
      b.xmlns = r.xhtml,
      jsPlumb.createElementNS(r.svg, a, null, null, b)
  },
  u = function(a) {
  ...
  var z = function(a) {
      ...
      this.svg = t("svg", g),
      a.useDivWrapper ? (this.canvas = jsPlumb.createElement("div", {
          position: "absolute"
  ...
  b.ConnectorRenderers.svg = function(a) {
      ...
      e.renderer.paint = function(e, f, g) {
          ...
          if (g.xmin < 0 && (j[0] = -g.xmin), g.ymin < 0 && (j[1] = -g.ymin), h.length > 0) {
              for (var k = 0; k < h.length; k++) i += b.Segments.svg.SegmentRenderer.getPath(h[k]),
              i += " ";
              var l = {
                  d: i,
              ...
              if (e.outlineColor) {
                  ...
                  e),
                  delete m.gradient,
                  m.strokeStyle = c.convertStyle(e.outlineColor),
                  m.lineWidth = p,
                  null == d.bgPath ? (d.bgPath = t("path", l), b.addClass(d.bgPath, b.connectorOutlineClass), y(d.svg, d.bgPath, 0)) : s(d.bgPath, l),
                  x(d.svg, d.bgPath, m, n, d)
              }
              null == d.path ? (d.path = t("path", l), y(d.svg, d.path, e.outlineColor ? 1 : 0)) : s(d.path, l),
              x(d.svg, d.path, e, n, d)
          }
      }
  },
  ...
  var A = b.SvgEndpoint = function(a) {
      ...
      d.renderer.paint = function(a) {
          var d = b.extend({},
          a);
          d.outlineColor && (d.strokeWidth = d.outlineWidth, d.strokeStyle = c.convertStyle(d.outlineColor, !0)),
          null == this.node ? (this.node = this.makeNode(d), this.svg.appendChild(this.node)) : null != this.updateNode && this.updateNode(this.node),
          x(this.svg, this.node, d, [this.x, this.y, this.w, this.h], this),
...
function() {
  ...
  k = function(a, b, c, d, e, f) {
      ...
      return f ? e.appendElement(g, d) : d.appendChild(g),
      g.className = (c["class"] ? c["class"] + " ": "") + "jsplumb_vml",
      l(g, b),
      j(g, c),
      g
  },
  ...
  o = function(a, b, d, e) {
      ...
      if (b.dashstyle) null == d.strokeNode ? d.strokeNode = k("stroke", [0, 0, 0, 0], {
  ...
  p = function() {
      ...
      this.initOpacityNodes = function(b) {
          ...
          a.opacityNodes.fill = k("fill", [0, 0, 1, 1], {
              opacity: "0.0"
          },
          b, a._jsPlumb.instance)
      },
      ...
      this.appendDisplayElement = function(b, d) {
          d || a.canvas.parentNode.appendChild(b),
          c.push(b)
      }
  };
  ...
  var q = b.ConnectorRenderers.vml = function(a, e) {
      ...
      this.paint = function(g) {
          if (null !== g) {
              ...
              n = [this.x, this.y, this.w, this.h], p = 0; p < h.length; p++) m.path += b.Segments.vml.SegmentRenderer.getPath(h[p]),
              m.path += " ";
              if (g.outlineColor) {
                  ...
                  null == this.bgCanvas ? (m["class"] = f, m.coordsize = n[2] * i + "," + n[3] * i, this.bgCanvas = k("shape", n, m, a.parent, this._jsPlumb.instance, !0), l(this.bgCanvas, n), this.appendDisplayElement(this.bgCanvas, !0), this.initOpacityNodes(this.bgCanvas, ["stroke"]), this.bgCanvas._jsPlumb = e) : (m.coordsize = n[2] * i + "," + n[3] * i, l(this.bgCanvas, n), j(this.bgCanvas, m)),
                  o(this.bgCanvas, s, this)
              }
              null == this.canvas ? (m["class"] = f, m.coordsize = n[2] * i + "," + n[3] * i, this.canvas = k("shape", n, m, a.parent, this._jsPlumb.instance, !0), this.appendDisplayElement(this.canvas, !0), this.initOpacityNodes(this.canvas, ["stroke"]), this.canvas._jsPlumb = e) : (m.coordsize = n[2] * i + "," + n[3] * i, l(this.canvas, n), j(this.canvas, m)),
              o(this.canvas, g, this, this._jsPlumb.instance)
          }
      }
  };
  c.extend(q, p, {
  ...
  var r = b.VmlEndpoint = function(a) {
      ...
      this.paint = function(a, b) {
          ...
          e = this._jsPlumb.vml;
          c.sizeElement(this.canvas, this.x, this.y, this.w, this.h),
          null == this._jsPlumb.vml ? (d["class"] = this._jsPlumb.clazz, e = this._jsPlumb.vml = this.getVml([0, 0, this.w, this.h], d, b, this.canvas, this._jsPlumb.instance), this.appendDisplayElement(e, !0), this.appendDisplayElement(this.canvas, !0), this.initOpacityNodes(e, ["fill"])) : (l(e, [0, 0, this.w, this.h]), j(e, d)),
          o(e, a, this)
      }
  };
  c.extend(r, p),
  ...
  c.extend(b.Endpoints.vml.Dot, r),
  b.Endpoints.vml.Rectangle = function() {
      b.Endpoints.Rectangle.apply(this, arguments),
      r.apply(this, arguments),
      this.getVml = function(a, b, c, d, e) {
  ...
  c.extend(b.Endpoints.vml.Rectangle, r),
  b.Endpoints.vml.Image = b.Endpoints.Image,
  b.Endpoints.vml.Blank = b.Endpoints.Blank,
  b.Overlays.vml.Label = b.Overlays.Label,
  b.Overlays.vml.Custom = b.Overlays.Custom;
  var s = function(a, b) {
      a.apply(this, b),
      p.apply(this, b);
      var d = this;
      ...
      this.paint = function(a, f) {
          if (a.component.canvas && f) {
              ...
              h = a.d,
              m = a.component;
              a.strokeStyle && (g.stroked = "true", g.strokecolor = c.convertStyle(a.strokeStyle, !0)),
              a.lineWidth && (g.strokeweight = a.lineWidth + "px"),
              a.fillStyle && (g.filled = "true", g.fillcolor = a.fillStyle);
              ...
              if (g.path = e(h), g.coordsize = m.w * i + "," + m.h * i, t[0] = m.x, t[1] = m.y, t[2] = m.w, t[3] = m.h, null == d.canvas) {
                  ...
                  g["class"] = v + " " + u,
                  d.canvas = k("shape", t, g, m.canvas.parentNode, m._jsPlumb.instance, !0),
                  m.appendDisplayElement(d.canvas, !0)
              } else l(d.canvas, t),
              j(d.canvas, g)
          }
      },
  ...
  c.extend(b.Overlays.vml.Arrow, [b.Overlays.Arrow, s]),
  b.Overlays.vml.PlainArrow = function() {
      s.apply(this, [b.Overlays.PlainArrow, arguments])
  },
  c.extend(b.Overlays.vml.PlainArrow, [b.Overlays.PlainArrow, s]),
  b.Overlays.vml.Diamond = function() {
...
function(a, b) {
  ...
  a.extend(b.jsPlumbInstance.prototype, {
      ...
      initDraggable: function(b, e, f) {
          e = e || {},
          b = a(b),
          e.start = d.wrap(e.start,
          function() {
              a("body").addClass(this.dragSelectClass)
          },
          !1),
          e.stop = d.wrap(e.stop,
          function() {
              a("body").removeClass(this.dragSelectClass)
          }),
          e.doNotRemoveHelper || (e.helper = null),
          "internal" == f && (e.scope = e.scope || c.Defaults.Scope),
          b.draggable(e)
      },
      initDroppable: function(b, d) {
          d.scope = d.scope || c.Defaults.Scope,
          a(b).droppable(d)
      },
